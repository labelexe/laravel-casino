...
<!-- TODO: сделать валюту нормально -->
<iframe id='game' style="position:absolute;top:0px;margin:0px;border:0px;width:100%;height:100vh;" src='/games/{{ $game->name }}/index.html?curr=rub&game={{ $game->name }}' allowfullscreen>
