@extends('frontend.Euroslot.layouts.app')
...
@section('content')
  ...
  <div class="phone-rotate">
    <div class="section"><img src="/frontend/Euroslot/images/rotate.gif" width="403"></div>
  </div>
...
<iframe id="" src="../frontend/Euroslot/allgames.php" style="position:absolute; width:100%; color: #000;height:100%;border:0;z-index:1;"></iframe>
...
function myFunction() {
  ...
  document.getElementById("demo").innerHTML = x;
            ...
            <div data-ix="roll-down-jp-1" id="jp1" class="jp-text-01 text-jp-number"><span class="jackpot__value jackpot4">
								            @if( count($jpgs) > 3 )
									            {{ $jpgs[3]->balance }}
								            @endif											
											</span></div>
            <div data-ix="roll-down-jp-2" id="jp2" class="jp-text-02 text-jp-number"><span class="jackpot__value jackpot4">
								            @if( count($jpgs) > 4 )
									            {{ $jpgs[4]->balance }}
								            @endif											
											</span></div>
            <div data-ix="roll-down-jp-3" id="jp3" class="jp-text-03 text-jp-number"><span class="jackpot__value jackpot4">
								            @if( count($jpgs) > 5 )
									            {{ $jpgs[5]->balance }}
								            @endif											
											</span></div>
...
<input type="search" id="mySearch" class="search" placeholder=" Find . . .">
		...
		<div class="container">
			<div class="footer__block">
				<div class="footer__left">
					...
					<span style="right: 6vw;
    position: fixed;
    bottom: 4.6vw;
    text-align: center;
    font-size: 2vw;
    font-family: fantasy;
    color: #ff9800;"><em></em> {{ Auth::user()->username }}</span>
				</div>
				<div class="">
					<div class="">
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <!--a href="/frontend/Euroslot/allgames.php"><img src="/frontend/Euroslot/images/allgames0.png" class="button"></a></div>
	<a href="/frontend/Euroslot/amatic.php"><img src="/frontend/Euroslot/images/amatic0.png" class="button1"></a></div>
	<a href="/frontend/Euroslot/table.php"><img src="/frontend/Euroslot/images/table0.png" class="button2"></a></div>
	<a href="/frontend/Euroslot/novomatic.php"><img src="/frontend/Euroslot/images/novomatic0.png" class="button4"></a></div>
	<a href="#"><img src="/frontend/Euroslot/images/egt1.png" class="button5"></a></div>
	<a href="/frontend/Euroslot/wazdan.php"><img src="/frontend/Euroslot/images/wazdan0.png" class="button6"></a></div-->
...
.logput:hover {
    ...
    z-index: 99999;
			            ...
			            <a href="../logout"><img src="../frontend/Euroslot/images/logout.png" class="logput"></a></div>
				          <a href=""><img src="../frontend/Euroslot/images/jackpot_bar.png" style="position: fixed;
    right: 0%;
    top: 0%;
    width: 100%;
    height: 9%;
    ...
    background-size: 7vw auto;
    z-index: 9999;"></a></div>
					          <a href=""><img src="../frontend/Euroslot/images/navbar.png" style="position: fixed;
    right: 0%;
    bottom: 0%;
    width: 104%;
    height: 15%;
    ...
    z-index: -1;"></a></div>
          ...
          <div class="div-main-button-cat-footer">
            ...
            <div class="btn-cat-02 div-batton-category"><a href="lobby-page/Euroslot.php" class="w-inline-block"><img src="images/Euroslot-3.png" class="img-btn-cat"></a></div>
  ...
  <script src="/frontend/Euroslot/js/kzr-dd-tronic.js" type="text/javascript"></script>
