...
mainSlotRes.open("POST", "/api/game/FirstClassTraveller/server?sessionId="+sessionStorage.getItem('sessionId'), true);
mainSlotRes.setRequestHeader('Content-type', 'application/json; charset=utf-8');
mainSlotRes.setRequestHeader('Authorization', token);
