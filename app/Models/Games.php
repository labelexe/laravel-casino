...
class Games extends Model
{
    ...
    {
        return $this->hasOne('App\Models\JPG', 'id', 'jpg_id');
    }
    public function game_win()
    {
        return $this->hasOne('App\Models\GameWin', 'game_id', 'original_id');
    }
    public function game_bank()
    {
        return $this->hasOne('App\Models\GameBank', 'shop_id', 'shop_id');
    }
    public function statistics()
    {
        $shop_id = (\Auth::check() ? \Auth::user()->shop_id : 0);
        return $this->hasMany('App\Models\StatGame', 'game', 'name')->where('shop_id', $shop_id)->orderBy('date_time', 'DESC');
    }
    ...
    {
        return $this->hasOne(\App\Models\File::class, 'id', 'logo_id');
    }
}
