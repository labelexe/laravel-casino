...
namespace App\Games\JadeHeavenCT;

use App\Games\JadeHeavenCT\SlotSettings as SlotSettings;
...
class Server
{
    public function get($request, $game)
    {
        ...
        {
            case 'create_session':
                $slotSettings->SetGameData('JadeHeavenCTCards', [
                    19,
                    44,
                    0,
                    37,
            ...
            case 'init_game':
                ...
                $slotSettings->SetGameData('JadeHeavenCTBonusWin', 0);
                $slotSettings->SetGameData('JadeHeavenCTFreeGames', 0);
                $slotSettings->SetGameData('JadeHeavenCTCurrentFreeGame', 0);
                $slotSettings->SetGameData('JadeHeavenCTCurrentFreeGame0', 0);
                $slotSettings->SetGameData('JadeHeavenCTTotalWin', 0);
                $slotSettings->SetGameData('JadeHeavenCTFreeBalance', 0);
                ...
                if( $lastEvent != 'NULL' )
                {
                    ...
                    if( $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame') < $slotSettings->GetGameData('JadeHeavenCTFreeGames') && $slotSettings->GetGameData('JadeHeavenCTFreeGames') > 0 )
                    {
            ...
            case 'poll':
                ...
                {
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('JadeHeavenCTTotalWin')) * 100;
                }
            ...
            case 'game_finished':
                $slotSettings->SetGameData('JadeHeavenCTBonusWin', 0);
                $slotSettings->SetGameData('JadeHeavenCTTotalWin', 0);
                $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame0');
            ...
            case 'subgame_finished':
                if( $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame0') < $slotSettings->GetGameData('JadeHeavenCTFreeGames') && $slotSettings->GetGameData('JadeHeavenCTFreeGames') > 0 )
                {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('JadeHeavenCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('JadeHeavenCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('JadeHeavenCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('JadeHeavenCTBonusWin') . ',"totalWin":' . $_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32 . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                    if( $slotSettings->GetGameData('JadeHeavenCTFreeGames') <= $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame0') )
                    {
                    ...
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = $slotSettings->GetGameData('JadeHeavenCTFreeBalance');
                    ...
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame0');
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame0');
            ...
            case 'play':
                ...
                for( $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 = 0; $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 < $_obf_0D3B2A04131D2F18191C37340F3E1F161B362122233C01; $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32++ )
                {
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' )
                    {
                        ...
                        $slotSettings->SetGameData('JadeHeavenCTCurrentFreeGame0', 0);
                        $slotSettings->SetGameData('JadeHeavenCTTotalWin', 0);
                        $slotSettings->SetGameData('JadeHeavenCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                    ...
                    {
                        $slotSettings->SetGameData('JadeHeavenCTCurrentFreeGame', $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame') + 1);
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' )
                    {
                        $slotSettings->SetGameData('JadeHeavenCTBonusWin', $slotSettings->GetGameData('JadeHeavenCTBonusWin') + $totalWin);
                        $slotSettings->SetGameData('JadeHeavenCTTotalWin', $slotSettings->GetGameData('JadeHeavenCTTotalWin') + $totalWin);
                        $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = $slotSettings->GetGameData('JadeHeavenCTFreeBalance');
                    }
                    else
                    {
                        $slotSettings->SetGameData('JadeHeavenCTTotalWin', $totalWin);
                    }
                    $fs = 0;
                    if( $scattersCount >= 2 )
                    {
                        if( $scattersCount >= 3 )
                        {
                            ...
                            $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][0] = $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['free_result'];
                            $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][0]['scatters_win'] = $scattersStr;
                            $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['free_game_total'] = 0;
                            ...
                            $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['free_games'] = $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames');
                    ...
                    $slotSettings->SetGameData('JadeHeavenCTGambleStep', 5);
                    $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('JadeHeavenCTCards');
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' )
                    {
                        $state = 'freespin';
                        ...
                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('JadeHeavenCTBonusWin') > 0 )
                        {
                            $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['is_free'] = true;
                    ...
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['total_win'] = $slotSettings->GetGameData('JadeHeavenCTTotalWin') / $denom;
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"result":' . json_encode($_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('JadeHeavenCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('JadeHeavenCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('JadeHeavenCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            case 'gamble':
                ...
                $totalWin = $slotSettings->GetGameData('JadeHeavenCTTotalWin');
                ...
                $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('JadeHeavenCTCards');
                $slotSettings->SetGameData('JadeHeavenCTGambleStep', $slotSettings->GetGameData('JadeHeavenCTGambleStep') - 1);
                ...
                else
                {
                    ...
                    $totalWin = 0;
                    $slotSettings->SetGameData('JadeHeavenCTGambleStep', 0);
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['continue_params']['double_key'] != 'red' && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['continue_params']['double_key'] != 'black' )
                    {
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['continue_params']['double_key'] == 'diamond' )
                        {
                ...
                $slotSettings->SetGameData('JadeHeavenCTCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
