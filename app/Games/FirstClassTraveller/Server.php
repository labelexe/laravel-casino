...
namespace App\Games\FirstClassTraveller;

use App\Games\FirstClassTraveller\SlotSettings as SlotSettings;
    ...
    class Server
    {
        ...
        { /*
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetUserCards' )
            {
                ...
                $_obf_0D040B162710402D331E2209370C14231F2C252B172601 = $slotSettings->GetGameData('FirstClassTravellerDealerCard');
                $totalWin = $slotSettings->GetGameData('FirstClassTravellerTotalWin');
                ...
                $slotSettings->SetGameData('FirstClassTravellerTotalWin', $totalWin);
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetDealerCard' )
            {
                ...
                $slotSettings->SetGameData('FirstClassTravellerDealerCard', $_obf_0D5B5C0F232838114030190505402A241E131019332901);
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' )
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] != 'freespin' )
                {
                    ...
                    $bonusMpl = 1;
                    $slotSettings->SetGameData('FirstClassTravellerBonusWin', 0);
                    $slotSettings->SetGameData('FirstClassTravellerFreeGames', 0);
                    $slotSettings->SetGameData('FirstClassTravellerCurrentFreeGame', 0);
                    $slotSettings->SetGameData('FirstClassTravellerTotalWin', 0);
                    $slotSettings->SetGameData('FirstClassTravellerFreeBalance', 0);
                }
                else
                {
                    $slotSettings->SetGameData('FirstClassTravellerCurrentFreeGame', $slotSettings->GetGameData('FirstClassTravellerCurrentFreeGame') + 1);
                ...
                for( $i = 0; $i <= 2000; $i++ )
                {
                    ...
                    $_obf_0D05360E3007232A1C27303C2C3E0B3023335B210C1232 = 'P_1_0_X';
                    for( $k = 0; $k < $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotLines']; $k++ )
                    {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ )
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    $mpl = 1;
                                    $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811 = 0;
                                    if( $s[0] == $wild && $s[1] == $wild )
                                    {
                                        $mpl = 1;
                                        $_obf_0D05360E3007232A1C27303C2C3E0B3023335B210C1232 = 'P_1';
                                        $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811 = -5;
                                    }
                                    ...
                                    if( $s[0] == $wild )
                                    {
                                        $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811++;
                                    }
                                    if( $s[1] == $wild )
                                    {
                                        $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811++;
                                    ...
                                    if( $mpl > 1 )
                                    {
                                        $mpl = $slotSettings->slotWildMplCount[$_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811];
                                    }
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 )
                                    {
                                        if( $s[0] == $wild )
                                        {
                                            $s[0] = $_obf_0D05360E3007232A1C27303C2C3E0B3023335B210C1232;
                                        }
                                        if( $s[1] == $wild )
                                        {
                                            $s[1] = $_obf_0D05360E3007232A1C27303C2C3E0B3023335B210C1232;
                                        }
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":2,"WildCount":' . $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811 . ',"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FirstClassTravellerBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) )
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 )
                                    {
                                        ...
                                        if( $s[2] == $wild )
                                        {
                                            $s[2] = $_obf_0D05360E3007232A1C27303C2C3E0B3023335B210C1232;
                                        }
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":3,"WildCount":' . $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811 . ',"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FirstClassTravellerBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[3] == $wild) )
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 )
                                    {
                                        ...
                                        if( $s[3] == $wild )
                                        {
                                            $s[3] = $_obf_0D05360E3007232A1C27303C2C3E0B3023335B210C1232;
                                        }
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":4,"WildCount":' . $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811 . ',"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FirstClassTravellerBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[3] == $wild) && ($s[4] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[4] == $wild) )
                                {
                                    ...
                                    if( $s[0] == $wild && $s[1] == $wild && $s[2] == $wild && $s[3] == $wild && $s[4] == $wild )
                                    {
                                        $mpl = 1;
                                        $_obf_0D05360E3007232A1C27303C2C3E0B3023335B210C1232 = 'P_1';
                                        $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811 = -10;
                                    }
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 )
                                    {
                                        ...
                                        if( $s[4] == $wild )
                                        {
                                            $s[4] = $_obf_0D05360E3007232A1C27303C2C3E0B3023335B210C1232;
                                        }
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":5,"WildCount":' . $_obf_0D0631321E2A3507332A19292F2C0E0A0A172E2B2E2811 . ',"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FirstClassTravellerBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' && $slotSettings->GetGameData('FirstClassTravellerFreeGames') <= $slotSettings->GetGameData('FirstClassTravellerCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('FirstClassTravellerTotalWin') + $totalWin > 0 )
                {
                    $slotSettings->SetBalance($slotSettings->GetGameData('FirstClassTravellerTotalWin') + $totalWin);
                }
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' )
                {
                    $slotSettings->SetGameData('FirstClassTravellerBonusWin', $slotSettings->GetGameData('FirstClassTravellerBonusWin') + $totalWin);
                    $slotSettings->SetGameData('FirstClassTravellerTotalWin', $slotSettings->GetGameData('FirstClassTravellerTotalWin') + $totalWin);
                    $totalWin = $slotSettings->GetGameData('FirstClassTravellerBonusWin');
                    $Balance = $slotSettings->GetGameData('FirstClassTravellerFreeBalance');
                }
                else
                {
                    $slotSettings->SetGameData('FirstClassTravellerTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 )
                {
                    if( $slotSettings->GetGameData('FirstClassTravellerFreeGames') > 0 )
                    {
                        $slotSettings->SetGameData('FirstClassTravellerFreeBalance', $Balance);
                        $slotSettings->SetGameData('FirstClassTravellerBonusWin', $totalWin);
                        $slotSettings->SetGameData('FirstClassTravellerFreeGames', $slotSettings->GetGameData('FirstClassTravellerFreeGames') + $slotSettings->slotFreeCount);
                    }
                    else
                    {
                        $slotSettings->SetGameData('FirstClassTravellerFreeBalance', $Balance);
                        $slotSettings->SetGameData('FirstClassTravellerBonusWin', $totalWin);
                        $slotSettings->SetGameData('FirstClassTravellerFreeGames', $slotSettings->slotFreeCount);
                    }
                }
