...
namespace App\Games\OldFishermanGM;

use App\Games\OldFishermanGM\SlotSettings as SlotSettings;
        ...
        switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 )
        {
            ...
            case 'spin':
                ...
                for( $i = 0; $i <= 2000; $i++ )
                {
                    ...
                    $scattersCount = 0;
                    $_obf_0D3303311514143B2F0F36083D1C0E5C170A332F163932 = 'b:0;';
                    for( $k = 0; $k < $lines; $k++ )
                    {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ )
                        {
                            ...
                            if( !isset($slotSettings->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132]) )
                            {
                            }
                            else
                            {
                                $s = [];
                                if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '12' )
                                {
                                    $wild = [''];
                                }
                                else
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) )
                                {
                                    ...
                                    if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '12' )
                                    {
                                        ...
                                        $_obf_0D3303311514143B2F0F36083D1C0E5C170A332F163932 = 'a:3:{i:0;a:3:{s:4:"reel";i:0;s:3:"pos";i:' . ($linesId[$k][0] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:1;a:3:{s:4:"reel";i:1;s:3:"pos";i:' . ($linesId[$k][1] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:2;a:3:{s:4:"reel";i:2;s:3:"pos";i:' . ($linesId[$k][2] - 1) . ';s:9:"animation";s:12:"scatterBonus";}}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) )
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 )
                                    {
                                        ...
                                        if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '12' )
                                        {
                                            ...
                                            $_obf_0D3303311514143B2F0F36083D1C0E5C170A332F163932 = 'a:4:{i:0;a:3:{s:4:"reel";i:0;s:3:"pos";i:' . ($linesId[$k][0] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:1;a:3:{s:4:"reel";i:1;s:3:"pos";i:' . ($linesId[$k][1] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:2;a:3:{s:4:"reel";i:2;s:3:"pos";i:' . ($linesId[$k][2] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:3;a:3:{s:4:"reel";i:3;s:3:"pos";i:' . ($linesId[$k][3] - 1) . ';s:9:"animation";s:12:"scatterBonus";}}';
                                        }
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) )
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 )
                                    {
                                        ...
                                        if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '12' )
                                        {
                                            ...
                                            $_obf_0D3303311514143B2F0F36083D1C0E5C170A332F163932 = 'a:5:{i:0;a:3:{s:4:"reel";i:0;s:3:"pos";i:' . ($linesId[$k][0] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:1;a:3:{s:4:"reel";i:1;s:3:"pos";i:' . ($linesId[$k][1] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:2;a:3:{s:4:"reel";i:2;s:3:"pos";i:' . ($linesId[$k][2] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:3;a:3:{s:4:"reel";i:3;s:3:"pos";i:' . ($linesId[$k][3] - 1) . ';s:9:"animation";s:12:"scatterBonus";}i:4;a:3:{s:4:"reel";i:4;s:3:"pos";i:' . ($linesId[$k][4] - 1) . ';s:9:"animation";s:12:"scatterBonus";}}';
                                        }
                                    }
                                }
                            }
                    ...
                    else
                    {
                        ...
                        if( $_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 && $winType != 'bonus' )
                        {
                        }
                ...
                $fs = 0;
                $_obf_0D1F1D2E10081A07100C323C22382309165B01100E1C01 = 'b:0;';
                $_obf_0D221E0127291332261A250B051F38332A101B100D1732 = 'b:0;';
                if( $_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 )
                {
                    $_obf_0D303824321032022116072C3F3F1A2225350B2B261611 = $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') + 1;
                    if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') > 0 )
                    {
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') + $slotSettings->slotFreeCount[$scattersCount[0]]);
                    }
                    else
                    {
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeStartWin', $totalWin);
                        $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', $totalWin);
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $slotSettings->slotFreeCount[$scattersCount[0]]);
                    }
                    $_obf_0D1F1D2E10081A07100C323C22382309165B01100E1C01 = 'i:' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ';';
                    $_obf_0D221E0127291332261A250B051F38332A101B100D1732 = 'a:1:{i:' . $scattersCount[1] . ';i:' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ';}';
