...
use App\Games\OldFishermanGM\GameReel as GameReel;
...
class SlotSettings
{
    ...
    public function __construct($sid, $playerId)
    {
        ...
        $user = \App\Models\User::lockForUpdate()->find($this->playerId);
        $this->user = $user;
    ...
    public function GetHistory()
    {
        ...
        foreach( $history as $log )
        {
            ...
            if( $_obf_0D1F212D1B1A262C271C2C331110342F041A3014182301->responseEvent != 'gambleResult' && $_obf_0D1F212D1B1A262C271C2C331110342F041A3014182301->responseEvent != 'gambleResult2' && $_obf_0D1F212D1B1A262C271C2C331110342F041A3014182301->responseEvent != 'jackpot' )
            {
    ...
    public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
    {
        ...
        {
            $_obf_0D172C04372D1A2A3C2B33260B34083837222A08343211 = $this->slotId . ' DGL';
        }
        $game = $this->game;
    ...
    public function GetReelStrips($winType, $slotEvent)
    {
        ...
        else
        {
            ...
            $_obf_0D15220A01301A2517063B0F1D0E040B280A1C01042622 = rand(0, 9);
