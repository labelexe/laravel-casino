<?php
namespace App\Games\BookOfMoorhuhnGoldenNightsGM;

use App\Games\BookOfMoorhuhnGoldenNightsGM\SlotSettings as SlotSettings;
    ...
    public function get($request, $game)
    {
        ...
        switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 )
        {
            ...
            case 'getFGPayTable':
                ...
                $lines = $slotSettings->GetGameData($slotSettings->slotId . 'Lines');
                if( $slotSettings->Paytable['SYM_' . $bs][2] > 0 )
                {
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = "INFO\$\$1\$\$a:1:{s:10:\"fgPayTable\";s:218:\"\t<div class=\"fgPayTable values4\">\n\t\t\t\t\t<div class=\"fgWinValue\" id=\"fgWinValue-5\">" . sprintf('%01.2f', $slotSettings->Paytable['SYM_' . $bs][5] * $bet) . "</div>\n\t\t\t\t\t<div class=\"fgWinValue\" id=\"fgWinValue-4\">" . sprintf('%01.2f', $slotSettings->Paytable['SYM_' . $bs][4] * $bet) . "</div>\n\t\t\t\t\t<div class=\"fgWinValue\" id=\"fgWinValue-3\">" . sprintf('%01.2f', $slotSettings->Paytable['SYM_' . $bs][3] * $bet) . "</div>\n\t\t\t\t\t<div class=\"fgWinValue\" id=\"fgWinValue-2\">" . sprintf('%01.2f', $slotSettings->Paytable['SYM_' . $bs][2] * $bet) . "</div>\n\t\t\t</div>\n\";}";
                }
                else
                {
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = "INFO\$\$1\$\$a:1:{s:10:\"fgPayTable\";s:218:\"\t<div class=\"fgPayTable values3\">\n\t\t\t\t\t<div class=\"fgWinValue\" id=\"fgWinValue-5\">" . sprintf('%01.2f', $slotSettings->Paytable['SYM_' . $bs][5] * $bet) . "</div>\n\t\t\t\t\t<div class=\"fgWinValue\" id=\"fgWinValue-4\">" . sprintf('%01.2f', $slotSettings->Paytable['SYM_' . $bs][4] * $bet) . "</div>\n\t\t\t\t\t<div class=\"fgWinValue\" id=\"fgWinValue-3\">" . sprintf('%01.2f', $slotSettings->Paytable['SYM_' . $bs][3] * $bet) . "</div>\n\t\t\t</div>\n\";}";
                }
                break;
            case 'showInfoSite':
            ...
            case 'spin':
                ...
                for( $i = 0; $i <= 2000; $i++ )
                {
                    ...
                    $_obf_0D2E24181C04311E04120E092F362809142506090D2501 = 0;
                    $_obf_0D3B06130F0128160C215C3E18393D010C1C2B1A1B0401 = 'a:0:{}';
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' )
                    {
                        $_obf_0D22162B01161F303027253114083C162C150325262822 = 'a:0:{}';
                        $_obf_0D2C3B0A132A28190C13101D2717401B38362C392C0F01 = 'a:0:{}';
                        $bs = $slotSettings->GetGameData($slotSettings->slotId . 'bonusSymbol');
                        $_obf_0D2D242F1E081F2409212525352A36071E090B03212811 = '';
                        $_obf_0D331B272A0906150E0612381131132A0E24013E021D11 = [];
                        $_obf_0D23103C3E1F15121A1307301D3F161C341A342F161401 = [];
                        $_obf_0D3F1C2D012E3E2D1F093B0E393C172F0A250F32402832 = 0;
                        $_obf_0D1A2F1B2E0B0C2E3B32300A3938381F383F1B015B5C01 = [];
                        $_obf_0D323F1E2D2D2B182F0B062C3E121D17261605373C1B11 = [
                            '',
                            'a',
                            'b',
                            'c',
                        ...
                        for( $r = 1; $r <= 5; $r++ )
                        {
                            if( $reels['reel' . $r][0] == $bs || $reels['reel' . $r][1] == $bs || $reels['reel' . $r][2] == $bs )
                            {
                                $_obf_0D2D242F1E081F2409212525352A36071E090B03212811 .= ('i:' . $r . ';i:' . $bs . ';');
                                $_obf_0D3F1C2D012E3E2D1F093B0E393C172F0A250F32402832++;
                                $_obf_0D1A2F1B2E0B0C2E3B32300A3938381F383F1B015B5C01[] = 's:1:"' . $_obf_0D323F1E2D2D2B182F0B062C3E121D17261605373C1B11[$r] . '";a:3:{i:0;i:' . $bs . ';i:1;i:' . $bs . ';i:2;i:' . $bs . ';}';
                            }
                            else
                            {
                                $_obf_0D2D242F1E081F2409212525352A36071E090B03212811 .= ('i:' . $r . ';b:0;');
                            }
                        }
                        $_obf_0D2E24181C04311E04120E092F362809142506090D2501 = $slotSettings->Paytable['SYM_' . $bs][$_obf_0D3F1C2D012E3E2D1F093B0E393C172F0A250F32402832] * $allbet;
                        $_obf_0D5C3C0E31310511271A063D08061A0D0F0C0612171B22 = $slotSettings->Paytable['SYM_' . $bs][$_obf_0D3F1C2D012E3E2D1F093B0E393C172F0A250F32402832] * $betline;
                        if( $_obf_0D2E24181C04311E04120E092F362809142506090D2501 > 0 )
                        {
                            for( $r = 0; $r < $lines; $r++ )
                            {
                                $_obf_0D331B272A0906150E0612381131132A0E24013E021D11[] = 'i:' . $r . ';a:6:{i:0;i:' . ($r + 1) . ';' . $_obf_0D2D242F1E081F2409212525352A36071E090B03212811 . '}';
                                $_obf_0D23103C3E1F15121A1307301D3F161C341A342F161401[] = 'i:' . ($r + 1) . ';i:' . ($_obf_0D5C3C0E31310511271A063D08061A0D0F0C0612171B22 * 100) . ';';
                            }
                        }
                        else
                        {
                        ...
                        $_obf_0D22162B01161F303027253114083C162C150325262822 = 'a:' . count($_obf_0D331B272A0906150E0612381131132A0E24013E021D11) . ':{' . implode('', $_obf_0D331B272A0906150E0612381131132A0E24013E021D11) . '}';
                        $_obf_0D2C3B0A132A28190C13101D2717401B38362C392C0F01 = 'a:' . count($_obf_0D23103C3E1F15121A1307301D3F161C341A342F161401) . ':{' . implode('', $_obf_0D23103C3E1F15121A1307301D3F161C341A342F161401) . '}';
                        $_obf_0D3B06130F0128160C215C3E18393D010C1C2B1A1B0401 = 'a:' . count($_obf_0D1A2F1B2E0B0C2E3B32300A3938381F383F1B015B5C01) . ':{' . implode('', $_obf_0D1A2F1B2E0B0C2E3B32300A3938381F383F1B015B5C01) . '}';
                    }
                    else
                    {
                        $_obf_0D22162B01161F303027253114083C162C150325262822 = 'b:0;';
                        $_obf_0D2C3B0A132A28190C13101D2717401B38362C392C0F01 = 'b:0;';
                    }
                    $totalWin += $_obf_0D2E24181C04311E04120E092F362809142506090D2501;
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' || $winType == 'bonus' )
                {
                    ...
                    $bSym = 'i:' . $slotSettings->GetGameData($slotSettings->slotId . 'bonusSymbol');
                }
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' )
                {
                    ...
                    $_obf_0D1F3E3D360D1D0B1C29190A291A383027270C17012D01 = 'a:5:{' . implode('', $_obf_0D26380D1A112E100F391706363219403B191038183701) . '}';
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[0] = 'INFO$$1$$a:1:{s:7:"display";a:1:{i:0;a:2:{s:4:"type";s:10:"spinresult";s:5:"value";a:50:{s:8:"winCoins";i:' . ($totalWin * 100) . ';s:8:"winLines";' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . 's:13:"winLinesCount";i:' . $_obf_0D15135C211C1F15172A3D0D31233F2B1A3F1231270411 . ';s:10:"winPerLine";' . $_obf_0D3B1722331D5C263B15293215380E1F3B1B071F100E32 . 's:12:"winFGPerLine";b:0;s:13:"bonusWinLines";' . $_obf_0D22162B01161F303027253114083C162C150325262822 . 's:15:"bonusWinPerLine";' . $_obf_0D2C3B0A132A28190C13101D2717401B38362C392C0F01 . 's:11:"bonusSymbol";' . $bSym . ';s:11:"fiveOfAKind";b:0;s:9:"freeGames";i:' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame')) . ';s:11:"actFreegame";i:' . $_obf_0D303824321032022116072C3F3F1A2225350B2B261611 . ';s:12:"maxFreegames";i:' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ';s:11:"freegameWin";i:' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ';s:10:"isFreeGame";b:1;s:12:"wonFreegames";i:0;s:11:"playerCoins";i:' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ';s:9:"winFactor";d:25;s:3:"x25";b:0;s:11:"symbolAnims";b:0;s:9:"blockAnim";b:0;s:12:"blockAnimPos";b:0;s:15:"actWinFreegames";b:0;s:19:"freeGamesAnimations";b:0;s:13:"replaceSymbol";b:0;s:9:"multiData";b:0;s:10:"totalMulti";b:0;s:8:"maxiplay";b:0;s:18:"additionalWinAnims";b:0;s:10:"multiLines";b:0;s:15:"specSymbolAnims";b:0;s:16:"extraTeaserReels";b:0;s:11:"stickyReels";b:0;s:12:"newStickyPos";b:0;s:19:"playRandomRetrigger";b:0;s:19:"wildSymbolPositions";b:0;s:12:"bonusSymbols";b:0;s:13:"isBookFeature";b:0;s:12:"actFreeRound";i:0;s:13:"maxFreeRounds";i:0;s:12:"freeRoundWin";i:0;s:14:"attentionSpins";a:5:{s:1:"a";i:0;s:1:"b";i:0;s:1:"c";i:0;s:1:"d";i:0;s:1:"e";i:0;}s:11:"teaserReels";' . $_obf_0D1F3E3D360D1D0B1C29190A291A383027270C17012D01 . 's:13:"amountSymbols";a:5:{s:1:"a";i:8;s:1:"b";i:12;s:1:"c";i:16;s:1:"d";i:20;s:1:"e";i:24;}s:18:"copySymbolsOnReels";' . $_obf_0D3B06130F0128160C215C3E18393D010C1C2B1A1B0401 . 's:20:"winFactorBeforeStamp";d:0;s:17:"reel_a_symboldata";' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[0] . 's:17:"reel_b_symboldata";' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[1] . 's:17:"reel_c_symboldata";' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[2] . 's:17:"reel_d_symboldata";' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[3] . 's:17:"reel_e_symboldata";' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[4] . '}}}}}';
                }
                break;
            case 'initGambleCard':
