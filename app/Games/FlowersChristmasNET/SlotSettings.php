...
use App\Games\FlowersChristmasNET\GameReel as GameReel;
...
class SlotSettings
{
    ...
    public function __construct($sid, $playerId)
    {
        ...
        */
        ...
        $this->slotWildMpl = 1;
        $this->GambleType = 1;
        $this->Denominations = \App\Models\Games::$values['denomination'];
    ...
    public function GetReelStrips($winType, $slotEvent)
    {
        ...
        else
        {
            ...
            $_obf_0D2E231302321E2F343D3B3E320D03190C0A0923342F01 = rand(4, count($_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601));
        ...
        foreach( $_obf_0D1F1D041B280532291A2C2B223C14135C2427303D0811 as $index => $value )
        {
            ...
            $_obf_0D12142F3E2C22310D091D1D021022361C242808340611 = count($key);
            $key[-1] = $key[$_obf_0D12142F3E2C22310D091D1D021022361C242808340611 - 1];
            $key[$_obf_0D12142F3E2C22310D091D1D021022361C242808340611] = $key[0];
