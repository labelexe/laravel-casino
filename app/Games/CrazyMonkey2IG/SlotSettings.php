...
use App\Games\CrazyMonkey2IG\GameReel as GameReel;
...
/*            if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' )
            ...
            //TODO: исправить это
            $this->playerId = $playerId;
            $user = \App\Models\User::find($this->playerId);
            $this->user = $user;
            $this->shop_id = 1;
            $game = \App\Models\Games::where([
                'name' => $this->slotId,
                'shop_id' => $this->shop_id
            ])->lockForUpdate()->first();
            $this->shop = \App\Models\Shop::find($this->shop_id);
            $this->game = $game;
            ...
            $this->slotViewState = ($game->slotViewState == '' ? 'Normal' : $game->slotViewState);
            $this->hideButtons = [];
            $this->jpgs = \App\Models\JPG::where('shop_id', $this->shop_id)->lockForUpdate()->get();
            $this->Line = [
                1,
                2,
                3,
        ...
        public function Bonus($bet, $fuseBet)
        {
            ...
            for( $i = 0; $i < 5; $i++ )
            {
                ...
                if( $i >= 4 )
                {
                    $_obf_0D3C3D3F40050E403D21010E3112050E120B5C3D0E3C01 = true;
                }
            ...
            $_obf_0D0F212D18365B301D304004132635140122163D0B2732 = 0;
            if( $_obf_0D3C3D3F40050E403D21010E3112050E120B5C3D0E3C01 )
            {
                $_obf_0D0F212D18365B301D304004132635140122163D0B2732 = 50;
                $_obf_0D291F172B030C095B3F40060D0808331D35082C130C01 = $_obf_0D0F212D18365B301D304004132635140122163D0B2732 * $bet;
                $_obf_0D3C162D36343E2D2D02371D080A2219080E0C26210232 += $_obf_0D291F172B030C095B3F40060D0808331D35082C130C01;
                $_obf_0D2D2F1A5B1A3E312F26112C19113D0A231919045C2732 = '"BonusWins":[' . implode(',', $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332) . '],"SuperWin":{"Coef":' . $_obf_0D0F212D18365B301D304004132635140122163D0B2732 . ',"Win":' . $_obf_0D291F172B030C095B3F40060D0808331D35082C130C01 . '},';
            }
            else
            {
            ...
            return [
                ...
                'super' => $_obf_0D3C3D3F40050E403D21010E3112050E120B5C3D0E3C01,
                'superwin' => $_obf_0D291F172B030C095B3F40060D0808331D35082C130C01,
                'supercoef' => $_obf_0D0F212D18365B301D304004132635140122163D0B2732
            ];
        }
        public function SuperWin($bet)
        {
            ...
            $_obf_0D3C162D36343E2D2D02371D080A2219080E0C26210232 += $_obf_0D362832171714063F2F145B3E251F362B012122193D32;
            $_obf_0D2D2F1A5B1A3E312F26112C19113D0A231919045C2732 = '"SuperWin":{"Coef":' . $_obf_0D1E071137182D332A1B0E1E0B3D260217153D133B2601[0] . ',"Win":' . $_obf_0D362832171714063F2F145B3E251F362B012122193D32 . '},';
            return [
                'win' => $_obf_0D3C162D36343E2D2D02371D080A2219080E0C26210232,
                'info' => $_obf_0D2D2F1A5B1A3E312F26112C19113D0A231919045C2732,
                'supercoef' => $_obf_0D1E071137182D332A1B0E1E0B3D260217153D133B2601[0]
            ];
        }
        public function GetHistory()
        {
            $history = \App\Models\GameLog::whereRaw('game_id=? and user_id=? ORDER BY id DESC LIMIT 10', [
                $this->slotDBId,
                $this->playerId
            ])->get();
            $this->lastEvent = 'NULL';
