<?php
namespace App\Games\CrazyMonkey2IG;

use App\Games\CrazyMonkey2IG\SlotSettings as SlotSettings;
...
/*            if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' )
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] == 'risk' && $slotSettings->GetGameData('CrazyMonkey2IGWin') <= 0 )
            {
            ...
            //dd( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822);

            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] )
            {
                case 'super':
                    $bet = $slotSettings->GetGameData('CrazyMonkey2IGLines');
                    $lines = $slotSettings->GetGameData('CrazyMonkey2IGBet');
                    $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $slotSettings->GetGameData('CrazyMonkey2IGSuperWin');
                    $_obf_0D5C1A1508342E2825261A1C341829163F3414222A0B22 = $slotSettings->GetGameData('CrazyMonkey2IGSuperStep');
                    $_obf_0D232E350D1A02255B363F172F023D2E02180E300B2311 = $slotSettings->GetGameData('CrazyMonkey2IGSuperCoef');
                    if( $_obf_0D5C1A1508342E2825261A1C341829163F3414222A0B22 > 3 )
                    {
                        $response = '{"responseEvent":"error","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] . '","serverResponse":"invalid super bonus state"}';
                        exit( $response );
                    }
                    $slotSettings->SetBalance(-1 * $_obf_0D142C241F1B181D2723252601234035375B141A063811);
                    $slotSettings->SetBank('bonus', $_obf_0D142C241F1B181D2723252601234035375B141A063811);
                    $bank = $slotSettings->GetBank('bonus');
                    for( $i = 0; $i <= 1000; $i++ )
                    {
                        $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32 = $slotSettings->SuperWin($bet * $lines);
                        $_obf_0D2406261C060E150A0204063B122F330216372A3D0D22 = [
                            0,
                            0,
                            0,
                            50,
                        ...
                        shuffle($_obf_0D2406261C060E150A0204063B122F330216372A3D0D22);
                        if( $_obf_0D2406261C060E150A0204063B122F330216372A3D0D22[0] == 0 )
                        {
                            $_obf_0D03170E3840095C2F39123E101812121A281A1B050311 = 0;
                        }
                        else
                        {
                            $_obf_0D03170E3840095C2F39123E101812121A281A1B050311 = $_obf_0D232E350D1A02255B363F172F023D2E02180E300B2311 + $_obf_0D2406261C060E150A0204063B122F330216372A3D0D22[0];
                        }
                        $totalWin = $_obf_0D03170E3840095C2F39123E101812121A281A1B050311 * ($bet * $lines);
                        $_obf_0D300523062B1B32265B033B2F1D2C3B0D28045C3F1232 = '"SuperWin":{"Coef":' . $_obf_0D03170E3840095C2F39123E101812121A281A1B050311 . ',"Win":' . $totalWin . '},';
                        if( $totalWin <= $bank )
                        {
                            break;
                        }
                    ...
                    if( $totalWin > 0 )
                    {
                        ...
                        $slotSettings->SetBank('bonus', $totalWin * -1);
                    }
                    $_obf_0D5C1A1508342E2825261A1C341829163F3414222A0B22++;
                    $slotSettings->SetGameData('CrazyMonkey2IGSuperWin', $totalWin);
                    $slotSettings->SetGameData('CrazyMonkey2IGSuperStep', $_obf_0D5C1A1508342E2825261A1C341829163F3414222A0B22);
                    $slotSettings->SetGameData('CrazyMonkey2IGSuperCoef', $_obf_0D03170E3840095C2F39123E101812121A281A1B050311);
                    $balance = $slotSettings->GetBalance();
                    $response = '{"Amount":"' . sprintf('%01.2f', $balance * $slotSettings->CurrentDenom) . '",' . $_obf_0D300523062B1B32265B033B2F1D2C3B0D28045C3F1232 . '"Credit":' . floor($balance) . ',"Denomination":"' . sprintf('%01.2f', $slotSettings->CurrentDenom) . '","RawCredit":' . floor($balance) . ',"Win":' . $totalWin . ',"args":{"Super":1},"cmd":"super","time":"20190328T124737"}';
                    if( $totalWin == 0 )
                    {
                        $totalWin = -1 * $_obf_0D142C241F1B181D2723252601234035375B141A063811;
                    }
                    $slotSettings->SaveLogReport($response, $_obf_0D142C241F1B181D2723252601234035375B141A063811, 1, $totalWin, 'BG2');
                    break;
                case 'init':
                    $balance = $slotSettings->GetBalance();
                    ...
                    break;
                case 'status':
                    if( !$slotSettings->HasGameData('CrazyMonkey2IGLines') || !$slotSettings->HasGameData('CrazyMonkey2IGBet') )
                    {
                        $slotSettings->SetGameData('CrazyMonkey2IGLines', 1);
                        $slotSettings->SetGameData('CrazyMonkey2IGBet', 1);
                    }
                    $balance = $slotSettings->GetBalance();
                    if( $slotSettings->GetGameData('CrazyMonkey2IGWin') > 0 )
                    {
                        $balance = $balance - $slotSettings->GetGameData('CrazyMonkey2IGWin');
                    }
                    $response = '{"Amount":"' . sprintf('%01.2f', $balance * $slotSettings->CurrentDenom) . '","BetArray":[' . implode(',', $slotSettings->Bet) . '],"Credit":"' . floor($balance) . '","Currency":"' . $slotSettings->slotCurrency . '","Denomination":"' . sprintf('%01.2f', $slotSettings->CurrentDenom) . '","FuseBet":' . $slotSettings->fuseBet . ',"HelpCoef":[[0,0,0],[200,1000,5000],[100,500,2000],[30,100,500],[20,50,200],[10,30,100],[5,10,50],[3,5,20],[2,3,10]],"LastBet":' . $slotSettings->GetGameData('CrazyMonkey2IGBet') . ',"LastFuse":false,"LastLines":' . $slotSettings->GetGameData('CrazyMonkey2IGLines') . ',"MaxWin":675000,"RawCredit":"' . $balance . '","Reels":[[7,1,5,3,8],[5,3,6,7,7],[6,8,7,8,1]],"Win":0,"args":{},"cmd":"status","time":"20181111T111512"}';
                    break;
                case 'start':
                    $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822 = ["req-id"=>"1","Bet"=>"1","action"=>"start","bet"=>"1","lines"=>"9"];
                    $balance = $slotSettings->GetBalance();
                    ...
                    for( $i = 0; $i <= 1500; $i++ )
                    {
                        ...
                        {
                            $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32 = $slotSettings->Bonus($bet * $lines, $fuseBet);
                            ...
                            $_obf_0D3C3D3F40050E403D21010E3112050E120B5C3D0E3C01 = $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['super'];
                            $_obf_0D291F172B030C095B3F40060D0808331D35082C130C01 = $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['superwin'];
                        }
                        else
                        {
                            $totalWin = 0;
                            $_obf_0D300523062B1B32265B033B2F1D2C3B0D28045C3F1232 = '';
                            $_obf_0D3C3D3F40050E403D21010E3112050E120B5C3D0E3C01 = false;
                            $_obf_0D291F172B030C095B3F40060D0808331D35082C130C01 = 0;
                        }
                        $reels = $slotSettings->GetReelStrips($_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01);
                        $lineWins = [
                            0,
                            0,
                            0,
                    ...
                    $_obf_0D3C3E1B3B390A080B195B1A04080B3C3B0F3026272332 = $totalWin;
                    ...
                    $slotSettings->SetGameData('CrazyMonkey2IGReels', $_obf_0D282A3E130518100418230D042B0A2B400930193F3232);
                    $slotSettings->SetGameData('CrazyMonkey2IGWin', $totalWin);
                    $slotSettings->SetGameData('CrazyMonkey2IGRisk', 1);
                    $slotSettings->SetGameData('CrazyMonkey2IGLines', $lines);
                    $slotSettings->SetGameData('CrazyMonkey2IGBet', $bet);
                    $slotSettings->SetGameData('CrazyMonkey2IGDealerCard', $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32);

                    if( $_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 && $_obf_0D3C3D3F40050E403D21010E3112050E120B5C3D0E3C01 )
                    {
                        $slotSettings->SetGameData('CrazyMonkey2IGSuperStep', 1);
                        $slotSettings->SetGameData('CrazyMonkey2IGSuperCoef', 50);
                        $slotSettings->SetGameData('CrazyMonkey2IGSuperWin', $_obf_0D291F172B030C095B3F40060D0808331D35082C130C01);
                    }
                    ...
                    $slotSettings->SaveLogReport($response, $bet, $lines, $totalWin, $_obf_0D40110C403C2D2D0B3B020B223932223F0B3F380D3711);
                    break;
                case 'finish':
                    $balance = $slotSettings->GetBalance();
                    $slotSettings->SetGameData('CrazyMonkey2IGWin', 0);
                    $response = '{"Amount":"' . sprintf('%01.2f', $balance * $slotSettings->CurrentDenom) . '","Credit":' . floor($balance) . ',"RawCredit":' . floor($balance) . ',"Reels":[' . $slotSettings->GetGameData('CrazyMonkey2IGReels') . '],"args":{},"cmd":"finish","time":"20181111T171830"}';
                    break;
                case 'risk':
