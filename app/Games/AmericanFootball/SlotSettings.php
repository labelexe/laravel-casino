...
//{
    use App\Games\AmericanFootball\GameReel as GameReel;
    class SlotSettings
    {
        ...
        { /*
            ...
            //$user = \App\Http\Controllers\UserController::lockForUpdate()->find($this->playerId);
            $this->user = $user;
            ...
            //$this->user->session = json_encode('a:5:{s:24:"AmericanFootballBonusWin";a:2:{s:8:"timelife";i:1636097381;s:7:"payload";i:0;}s:25:"AmericanFootballFreeGames";a:2:{s:8:"timelife";i:1636097381;s:7:"payload";i:0;}s:31:"AmericanFootballCurrentFreeGame";a:2:{s:8:"timelife";i:1636097381;s:7:"payload";i:0;}s:24:"AmericanFootballTotalWin";a:2:{s:8:"timelife";i:1636097381;s:7:"payload";i:0;}s:27:"AmericanFootballFreeBalance";a:2:{s:8:"timelife";i:1636097381;s:7:"payload";d:1076016.37;}}');
            //$this->user->session = json_encode($this->user->session2);
