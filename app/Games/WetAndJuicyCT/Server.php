...
namespace App\Games\WetAndJuicyCT;
use App\Games\WetAndJuicyCT\SlotSettings as SlotSettings;
...
class Server
{
    public function get($request, $game)
    {
        ...
        {
            case 'create_session':
                $slotSettings->SetGameData('WetAndJuicyCTCards', [
                    19,
                    44,
                    0,
                    37,
            ...
            case 'init_game':
                ...
                $slotSettings->SetGameData('WetAndJuicyCTBonusWin', 0);
                $slotSettings->SetGameData('WetAndJuicyCTFreeGames', 0);
                $slotSettings->SetGameData('WetAndJuicyCTCurrentFreeGame', 0);
                $slotSettings->SetGameData('WetAndJuicyCTCurrentFreeGame0', 0);
                $slotSettings->SetGameData('WetAndJuicyCTTotalWin', 0);
                $slotSettings->SetGameData('WetAndJuicyCTFreeBalance', 0);
                ...
                if( $lastEvent != 'NULL' )
                {
                    ...
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['init_game'][0]['game_config']['init_screen'][3] = [
                        '' . $reels->reel1[3],
                        '' . $reels->reel2[3],
                        '' . $reels->reel3[3],
                        '' . $reels->reel4[3],
                    ...
                    if( $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame') < $slotSettings->GetGameData('WetAndJuicyCTFreeGames') && $slotSettings->GetGameData('WetAndJuicyCTFreeGames') > 0 )
                    {
            ...
            case 'poll':
                ...
                {
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('WetAndJuicyCTTotalWin')) * 100;
                }
            ...
            case 'game_finished':
                $slotSettings->SetGameData('WetAndJuicyCTBonusWin', 0);
                $slotSettings->SetGameData('WetAndJuicyCTTotalWin', 0);
                $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame0');
            ...
            case 'subgame_finished':
                if( $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame0') < $slotSettings->GetGameData('WetAndJuicyCTFreeGames') && $slotSettings->GetGameData('WetAndJuicyCTFreeGames') > 0 )
                {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('WetAndJuicyCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('WetAndJuicyCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('WetAndJuicyCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('WetAndJuicyCTBonusWin') . ',"totalWin":' . $_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32 . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                    if( $slotSettings->GetGameData('WetAndJuicyCTFreeGames') <= $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame0') )
                    {
                    ...
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = $slotSettings->GetGameData('WetAndJuicyCTFreeBalance');
                    ...
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame0');
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame0');
            ...
            case 'play':
                ...
                for( $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 = 0; $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 < $_obf_0D3B2A04131D2F18191C37340F3E1F161B362122233C01; $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32++ )
                {
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' )
                    {
                        ...
                        $slotSettings->SetGameData('WetAndJuicyCTCurrentFreeGame0', 0);
                        $slotSettings->SetGameData('WetAndJuicyCTTotalWin', 0);
                        $slotSettings->SetGameData('WetAndJuicyCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                    ...
                    {
                        $slotSettings->SetGameData('WetAndJuicyCTCurrentFreeGame', $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame') + 1);
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' )
                    {
                        $slotSettings->SetGameData('WetAndJuicyCTBonusWin', $slotSettings->GetGameData('WetAndJuicyCTBonusWin') + $totalWin);
                        $slotSettings->SetGameData('WetAndJuicyCTTotalWin', $slotSettings->GetGameData('WetAndJuicyCTTotalWin') + $totalWin);
                        $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = $slotSettings->GetGameData('WetAndJuicyCTFreeBalance');
                    }
                    else
                    {
                        $slotSettings->SetGameData('WetAndJuicyCTTotalWin', $totalWin);
                    }
                    $fs = 0;
                    if( $scattersCount >= 3 )
                    {
                    ...
                    $slotSettings->SetGameData('WetAndJuicyCTGambleStep', 5);
                    $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('WetAndJuicyCTCards');
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' )
                    {
                        $state = 'freespin';
                        ...
                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('WetAndJuicyCTBonusWin') > 0 )
                        {
                            $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['is_free'] = true;
                    ...
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['result_reels'][3] = [
                        $reels['reel1'][3],
                        $reels['reel2'][3],
                        $reels['reel3'][3],
                        $reels['reel4'][3],
                    ...
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['request_params']['game_denom'] = $denom;
                    ...
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['total_win'] = $slotSettings->GetGameData('WetAndJuicyCTTotalWin') / $denom;
                    ...
                    if( $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 == 0 && $winType == 'bonus' )
                    {
                        ...
                        $_obf_0D3B2A04131D2F18191C37340F3E1F161B362122233C01 += $slotSettings->slotFreeCount;
                    }
                }
                $slotSettings->SetGameData($slotSettings->slotId . 'Results', $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result']);
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"result":' . json_encode($_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('WetAndJuicyCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('WetAndJuicyCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('WetAndJuicyCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            case 'gamble':
                ...
                $totalWin = $slotSettings->GetGameData('WetAndJuicyCTTotalWin');
                ...
                $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('WetAndJuicyCTCards');
                $slotSettings->SetGameData('WetAndJuicyCTGambleStep', $slotSettings->GetGameData('WetAndJuicyCTGambleStep') - 1);
                ...
                else
                {
                    ...
                    $totalWin = 0;
                    $slotSettings->SetGameData('WetAndJuicyCTGambleStep', 0);
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['continue_params']['double_key'] != 'red' && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['continue_params']['double_key'] != 'black' )
                    {
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['continue_params']['double_key'] == 'diamond' )
                        {
                ...
                $slotSettings->SetGameData('WetAndJuicyCTCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
